...
// Compatibility exports for the legacy CanvasKit text renderer. The current
// coverage API also tracks language-aware CJK runs, while these helpers only
// need the script and font style for one character.
