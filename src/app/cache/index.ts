...
// Keep the legacy camel-case names used by the embedded-device memory bridge.
export const readCacheJson = readCacheJSON
export const writeCacheJson = writeCacheJSON
